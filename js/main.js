...
function insertText(text) {
  ...
  let textField = document.activeElement.classList.contains("inputs")
...
function changeButton() {
  practiceButton.innerHTML == "make/edit"
    ? (practiceButton.innerHTML = "Use")
    : (practiceButton.innerHTML = "make/edit");
}
// check screenstatus
function checkScreen() {
  ...
  if (!selectedSet) {
    console.log("falsey selected Set");
    ...
    hide("discard");
    // changeButton();
    practiceButton.innerHTML == "Use" ? hide("task_menu") : null;
  }
...
practiceButton.addEventListener("pointerdown", () => {
  checkScreen();
});
aButton.addEventListener("pointerdown", () => {
  insertText("ä");
});
oButton.addEventListener("pointerdown", () => {
  insertText("ö");
});
...
advanced.addEventListener("pointerdown", () => {
  hideShow("additional_options");
  toggleActive("advanced");
});
archiveAccessButton.addEventListener("pointerdown", () => {
  archiveAccess();
});
